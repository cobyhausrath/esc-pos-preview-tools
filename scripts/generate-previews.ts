...
// Add sample files generated by python-escpos
const sampleFiles = [
  { name: 'receipt.bin', description: 'Comprehensive receipt (python-escpos)' },
  { name: 'minimal.bin', description: 'Minimal test case (python-escpos)' },
  { name: 'formatting.bin', description: 'Text formatting test (python-escpos)' },
];

for (const sample of sampleFiles) {
  const samplePath = join(SAMPLES_DIR, sample.name);
